...
// https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&category=674&page=show_problem&problem=1541
// Date: 2021-08-27 13:05:59
// Runtime: 0.000
// Verdict: AC
...
int main() {
    ...
    while (TC--) {
        ...
        cout << mst_first << " " << mst_second << endl;
    }
}